...
let clickedPop = `<div class="NewclickedMSG" style="position: absolute;
                    ...
                    ">
                    <div class="popMSG" style="position: absolute;
                    left: 50%;
                    top: 50%;
                    ...
                    border-radius: 12px;
                    color: var(--textColor);">
                        <p>Systumm Phadengey!!</p>
                    </div>
                    </div>
                            `;

let NewclickedMSG = document.getElementById('NewclickedMSG');
...
notApps.forEach(function(el){
    el.addEventListener('click', function () {
        ...
        NewclickedMSG.innerHTML = clickedPop;
    
        body.appendChild(NewclickedMSG);
    
        setTimeout(() => {
            NewclickedMSG.innerHTML = "";
        }, 2000);
    })
})
...
nada.forEach(function(el){
    el.addEventListener('click', function () {
        ...
        NewclickedMSG.innerHTML = `<div class="NewclickedMSG" style="position: absolute;
        z-index: 417047847385;
        left: 0%;
        top: 0%;
        background-color: var(--hovColor);
